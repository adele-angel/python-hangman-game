...
def check_win(secret_word, old_letters_guessed):
    ...
    :return: if all the letters of the secret word are included in the list of letters
    :rtype: bool
    '''
...
def show_hidden_word(secret_word, old_letters_guessed):
    ...
    :type secret_word: str
    :type old_letters_guessed: list
    :return: if the guessed letter is valid and not included in the list of the guessed letters
    :rtype: bool
    '''
    word_to_guess = ''
    for char in secret_word:
...
def try_update_letter_guessed(letter_guessed, old_letters_guessed):
    '''Uses the check_valid_input function to know if the character is invalid and check_guess if not previously guessed.
    ...
    :type old_letters_guessed: list
    :return: if the current guessed letter is valid and not included in the list of the guessed letters
    :rtype: bool
    '''
    if not check_valid_input(letter_guessed):
        print('X')
        return False
    elif check_guess(letter_guessed, old_letters_guessed):
        print('X')
...
def check_valid_input(letter_guessed):
    '''Recives a character and checks if input is a valid. Valid input contains a single letter
    :param letter_guessed: user input
    :type letter_guessed: str
    :return: if the current guessed letter is valid
    :rtype: bool
    '''
    return letter_guessed.isalpha() and len(letter_guessed) == 1


def check_guess(letter, letter_list):
    '''Recives a character and a list of letters that and checks if the letter is included in the list
    ::param letter: user input
    :param letter_list: user previous guesses or secret word
    :type letter: str
...
def main():
    MAX_TRIES = 6
    start_screen(MAX_TRIES)  # Print the Welcome Screen
    ...
    while num_of_tries <= MAX_TRIES:
        ...
        if try_update_letter_guessed(letter_guessed, old_letters_guessed):
            if not check_guess(letter_guessed, secret_word):
                print(":(")
                num_of_tries += 1
                print_hangman(num_of_tries)
            print(show_hidden_word(secret_word, old_letters_guessed))
